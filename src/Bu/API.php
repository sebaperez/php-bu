<?php
	...
	class API extends Bu {
		...
		public static function API_ERROR_LOGIN_WRONG_CREDENTIALS() { return "API_ERROR_LOGIN_WRONG_CREDENTIALS"; }
		public static function API_ERROR_VALIDATION() { return "API_ERROR_VALIDATION"; }
		public static function API_UNKNOWN_ERROR() { return "API_UNKNOWN_ERROR";}

		public static function API_ATTRIBUTE_NO_REQUIRES_LOGIN() { return "API_ATTRIBUTE_NO_REQUIRES_LOGIN"; }
			...
			return [
				"user/login" => [
					...
					"function" => function($params) {
						...
						if ($session) {
							return $this->setOK([ "session" => $session->getValue("hash") ]);
						} else {
